...
class Game {
  ...
  if(ManagePlayer.playerO.containsAll(0, 1)&& emptyCells.contains(2))
      {index=2;}
  else if(ManagePlayer.playerO.containsAll(3, 4)&& emptyCells.contains(5))
      {index=5;}
  else if(ManagePlayer.playerO.containsAll(6, 7)&& emptyCells.contains(8))
      {index=8;}
  else if(ManagePlayer.playerO.containsAll(0, 3)&& emptyCells.contains(6))
      {index=6;}
  else if(ManagePlayer.playerO.containsAll(1, 4)&& emptyCells.contains(7))
      {index=7;}
  else if(ManagePlayer.playerO.containsAll(2, 5)&& emptyCells.contains(8))
      {index=8;}
  else if(ManagePlayer.playerO.containsAll(2, 4)&& emptyCells.contains(5))
      {index=6;}
  else if(ManagePlayer.playerO.containsAll(0, 2)&& emptyCells.contains(1))
      {index=1;}
  else if(ManagePlayer.playerO.containsAll(3, 5)&& emptyCells.contains(4))
      {index=4;}
  else if(ManagePlayer.playerO.containsAll(6, 8)&& emptyCells.contains(7))
      {index=7;}
  else if(ManagePlayer.playerO.containsAll(0, 6)&& emptyCells.contains(3))
      {index=3;}
  else if(ManagePlayer.playerO.containsAll(1, 7)&& emptyCells.contains(4))
      {index=4;}
      ...
      {index=4;}
  else if(ManagePlayer.playerO.containsAll(2, 6)&& emptyCells.contains(4))
      {index=4;}
      ...
      {index=3;}
  else if(ManagePlayer.playerO.containsAll(7, 8)&& emptyCells.contains(6))
      {index=6;}
  else if(ManagePlayer.playerO.containsAll(3, 6)&& emptyCells.contains(0))
      {index=0;}
  else if(ManagePlayer.playerO.containsAll(4, 7)&& emptyCells.contains(1))
      {index=1;}
  else if(ManagePlayer.playerO.containsAll(5, 8)&& emptyCells.contains(2))
      {index=2;}
  else if(ManagePlayer.playerO.containsAll(4, 8)&& emptyCells.contains(0))
      {index=0;}
  else if(ManagePlayer.playerO.containsAll(4, 6)&& emptyCells.contains(2))
      {index=2;}
  else
  {
